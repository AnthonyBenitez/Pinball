...
class FakeDataHandler(webapp2.RequestHandler):
    def get(self):
        ...
        p11 = playermodels.PlayerModel(firstName="Anthony", lastName="Benitez",
         email="tony20882@gmail.com", score=13405000, machine='adams family', invalidated=False)
        p11.put()
        p12 = playermodels.PlayerModel(firstName="Langston", lastName="Luck",
         email="langstonluck@gmail.com", score=7723567, machine='adams family', invalidated=False)
        p12.put()
        p13 = playermodels.PlayerModel(firstName="Jon", lastName="Pinball",
         email="pinballben@gmail.com", score=4592311, machine='adams family', invalidated=False)
        p13.put()
        p14 = playermodels.PlayerModel(firstName="Steven", lastName="Homie",
         email="johnny@gmail.com", score=56992359, machine='adams family', invalidated=False)
        p14.put()
        p15 = playermodels.PlayerModel(firstName="Jeff", lastName="Homie",
         email="dude@gmail.com", score=74591305, machine='adams family', invalidated=False)
        p15.put()
